#!/usr/bin/env python3
"""
go2k_manual 수동 라벨링을 GT로 사용하여 SAHI 탐지 정확도 평가

실행: python eval_go2k_sahi.py
GPU: python eval_go2k_sahi.py --device 0
"""
...
parser.add_argument("--iou-thresh", type=float, default=0.5, help="IoU 매칭 임계값")
...
model = AutoDetectionModel.from_pretrained(
    model_type="yolov8",
    model_path="/home/lay/hoban/hoban_go500_finetune/weights/best.pt",
...
# 결과 출력
print(f"\n{'=' * 60}")
print(f"go500 fine-tune + SAHI 평가 결과 (vs 수동 라벨링 GT)")
print(f"{'=' * 60}")
