...
| 항목 | 초기 (640x640) | 타일 최적화 | **현재 (최종)** |
|------|----------------|-------------|-----------------|
| 모델 | go2k_v2 best.pt | 동일 | 동일 |
| conf | 0.50 | 0.50 | **0.55** |
| SAHI slice | 640×640, overlap 0.2 | 1280×720, overlap 0.15 | **1280×720, overlap 0.15** |
| perform_standard_pred | False | False | **True** |
| postprocess | NMS/0.4/IOS | NMS/0.4/IOS | **NMS/0.4/IOS** |
| Precision | 0.725 | 0.884 | **0.893** |
| Recall | 0.903 | 0.942 | **0.935** |
| F1 | 0.804 | 0.912 | **0.914** |
| FP | 575 | 208 | **188** |

개선 이력: 타일 크기(+10.8%p) → perform_standard_pred(+0.2%p)
상세: `TILE_SIZE_EVAL.md`, `PLAN_COMPREHENSIVE_EVAL.md`
스크립트: `detect_go2k_sahi.py` (최종 설정 반영 완료)
...
| `eval_comprehensive.py` | 6 Phase 종합 최적화 (모델/overlap/per-class/TTA/앙상블/gate) |
